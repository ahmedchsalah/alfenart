		...
		<div id="content">
			...
			<section class="slider-section fullscreen-style" id="home">
				<div id="rev_slider_46_1_wrapper" class="rev_slider_wrapper fullscreen-container" data-alias="notgeneric1" style="background-color:transparent;padding:0px;">
					...
					<div id="rev_slider_46_1" class="rev_slider fullscreenbanner" style="display:none;" data-version="5.0.7">
						<ul>
							<!-- SLIDE  -->
							<li data-index="rs-149" data-transition="zoomout" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000"  data-rotate="0"  data-saveperformance="off"  data-title="HTML5 Video" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
								<!-- MAIN IMAGE -->
								<img src="upload/architecture/slide1.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
								<!-- LAYERS -->
								...
								<div class="tp-caption NotGeneric-SubTitle   tp-resizeme rs-parallaxlevel-2"
									...
									style="z-index: 6; white-space: nowrap;"><span>interior</span>
								</div>
								...
								<div class="tp-caption NotGeneric-Title   tp-resizeme rs-parallaxlevel-3"
									...
									style="z-index: 5; white-space: nowrap;">Building excellence
								</div>
								...
								<div class="tp-caption NotGeneric-SubTitle   tp-resizeme rs-parallaxlevel-2"
									...
									data-splitout="none"
									data-responsive_offset="on"
									style="z-index: 6; white-space: nowrap;">Innovation at work
								</div>
								...
								<div class="tp-caption NotGeneric-SubTitle   tp-resizeme rs-parallaxlevel-2"
									...
									data-splitout="none"
									data-responsive_offset="on"
									style="z-index: 6; white-space: nowrap;"><a href="portfolio.blade.php">All Projects</a>
								</div>

							</li>

							<!-- SLIDE  -->
							<li data-index="rs-150" data-transition="zoomout" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000"  data-rotate="0"  data-saveperformance="off"  data-title="HTML5 Video" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
								<!-- MAIN IMAGE -->
								<img src="upload/architecture/slide1.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
								<!-- LAYERS -->
								...
								<div class="tp-caption NotGeneric-SubTitle   tp-resizeme rs-parallaxlevel-2"
									...
									data-splitout="none"
									data-responsive_offset="on"
									style="z-index: 6; white-space: nowrap;"><span>building</span>
								</div>
								...
								<div class="tp-caption NotGeneric-Title   tp-resizeme rs-parallaxlevel-3"
									...
									data-responsive_offset="on"
									data-elementdelay="0.05"
									style="z-index: 5; white-space: nowrap;">Craft Design
								</div>

								<!-- LAYER NR. 3 -->
								<div class="tp-caption NotGeneric-SubTitle   tp-resizeme rs-parallaxlevel-2"
									id="slide-150-layer-3"
									data-x="['center','center','center','center']"
									data-y="['center','center','center','center']"
									data-hoffset="['170','0','0','0']"
									data-voffset="['80','70','60','50']"
						...
						<div class="row">
							<div class="col-lg-4 col-md-6">
								<div class="services-post">
									<a href="single-project.blade.php"><i class="fas fa-university"></i></a>
									<h4>Construction</h4>
									<p>touch the Sky</p>
								</div>
							</div>
							<div class="col-lg-4 col-md-6">
								<div class="services-post">
									<a href="single-project.blade.php"><i class="fas fa-brush"></i></a>
							...
							<div class="col-lg-4 col-md-6">
								<div class="services-post">
									<a href="single-project.blade.php"><i class="fas fa-paint-roller"></i></a>
									<h4>Design And Build</h4>
									<p>From imagination to real </p>
								</div>
							</div>
							<div class="col-lg-4 col-md-6">
								<div class="services-post">
									<a href="single-project.blade.php"><i class="fas fa-briefcase"></i></a>
									<h4>Consulting</h4>
									<p>Shapping for a better future</p>
								</div>
							</div>
							<div class="col-lg-4 col-md-6">
								<div class="services-post">
									<a href="single-project.blade.php"><i class="fas fa-wrench"></i></a>
									<h4>Special Projects</h4>
									<p>Building castle out of waste </p>
								</div>
							</div>
							<div class="col-lg-4 col-md-6">
								<div class="services-post">
									<a href="single-project.blade.php"><i class="fas fa-laptop-house"></i></a>
									<h4>House Renvation</h4>
					...
					<div class="team-box">
						<div class="row">
							<div class="col-md-4">
								<div class="team-post">
									<div class="image-holder">
										<img src="upload/architecture/member1.jpg" alt="member1">
									</div>
							...
							<div class="col-md-4">
								<div class="team-post">
									<div class="image-holder">
										<img src="upload/architecture/member2.jpg" alt="member2">
									</div>
									<div class="hover-team">
										<ul class="social-team">
											<li>
							...
							<div class="col-md-4">
								<div class="team-post">
									<div class="image-holder">
										<img src="upload/architecture/member3.jpg" alt="member3">
									</div>
									<div class="hover-team">
										<ul class="social-team">
											<li>
							...
							<div class="col-lg-6">
								<ul class="nav nav-tabs" id="myTab" role="tablist">
									<li class="nav-item" role="presentation">
										<button class="nav-link active" id="choose-tab" data-bs-toggle="tab" data-bs-target="#choose" type="button" role="tab" aria-controls="choose" aria-selected="true">why choose us</button>
									</li>
									<li class="nav-item" role="presentation">
								...
								<div class="tab-content" id="myTabContent">
									<div class="tab-pane fade show active" id="choose" role="tabpanel" aria-labelledby="choose-tab">
										<div class="row">
											<div class="col-lg-4">
												<img src="upload/architecture/tab1.jpg" alt="tab1">
											</div>
											<div class="col-lg-8">
									...
									<div class="accordion-item">
										<h2 class="accordion-header" id="headingOne">
											<button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
												...
												<span>For the trust, you have on us</span>
											</button>
										</h2>
									...
									<div class="accordion-item">
										<h2 class="accordion-header" id="headingTwo">
											<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
												...
												<span>Modern designs served with quality</span>
											</button>
										</h2>
									...
									<div class="accordion-item">
										<h2 class="accordion-header" id="headingThree">
											<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
												...
												<span>Designs too original to be copied</span>
											</button>
										</h2>
						...
						<div class="row">
							<div class="col-lg-5">
								<div class="feature-content">
									...
									<a href="portfolio.blade.php" class="theme-button"><span>Projects</span></a>
								</div>
							</div>
							<div class="col-lg-7">
								<div class="image-holder">
									<img src="upload/architecture/transformational_designs.png" alt="transformational_designs">
								</div>
							</div>
						</div>
					</div>
						...
						<div class="owl-carousel owl-theme" data-num="3">
							...
							<div class="item">
								<div class="scroller-post">
									<div class="image-holder">
										<img src="upload/architecture/s1.jpg" alt="s1">
									</div>
									<div class="hover-box">
										<span>01</span>
										<a class="cat-link" href="portfolio.blade.php">buildings</a>
										<h4><a href="single-project.blade.php">The concept for better living</a></h4>
									</div>
								</div>
							</div>
							...
							<div class="item">
								<div class="scroller-post">
									<div class="image-holder">
										<img src="upload/architecture/s2.jpg" alt="s2">
									</div>
									<div class="hover-box">
										<span>02</span>
										<a class="cat-link" href="portfolio.blade.php">buildings</a>
										<h4><a href="single-project.blade.php">Dreams under construction</a></h4>
									</div>
								</div>
							</div>
							...
							<div class="item">
								<div class="scroller-post">
									<div class="image-holder">
										<img src="upload/architecture/s3.jpg" alt="s3">
									</div>
									<div class="hover-box">
										<span>03</span>
										<a class="cat-link" href="portfolio.blade.php">buildings</a>
										<h4><a href="single-project.blade.php">Shaping for a better future</a></h4>
									</div>
								</div>
							</div>
				...
				<div class="container">
					...
					<div class="blog-box">
						<div class="row">
							<div class="col-lg-4">
								<div class="blog-post">
									<a href="single-post.blade.php" class="post-thumbnail">
										<img src="upload/architecture/blog1.jpg" alt="">
									</a>
									<div class="post-content">
										...
										<h3><a href="single-post.blade.php">Designing with balance and care</a></h3>
										<p>Individuals require a place to live, work, play, learn, shop, and eat. Architects are in charge of planning these</p>
										<a class="button-one" href="single-post.blade.php"><span>Read More</span></a>
									</div>
								</div>
							</div>
							<div class="col-lg-4">
								<div class="blog-post">
									<a href="single-post.blade.php" class="post-thumbnail">
										<img src="upload/architecture/blog2.jpg" alt="">
									</a>
									<div class="post-content">
										<ul class="meta-list">
											<li>
							...
							<div class="col-lg-4">
								<div class="blog-post">
									<a href="single-post.blade.php" class="post-thumbnail">
										<img src="upload/architecture/blog3.jpg" alt="">
									</a>
									<div class="post-content">
										<ul class="meta-list">
											<li>
								...
								<form id="contact-form">
									...
									<div class="row">
										<div class="col-md-6">
											...
											<div class="input-line">
												<label for="website"><i class="fas fa-link"></i></label>
			...
			<footer class="template-footer">
				...
				<div class="instagram-line">
					<div class="container">
						<ul class="insta-list">
							<li><a href="#"><img src="upload/architecture/instagram/1.jpg" alt=""></a></li>
							<li><a href="#"><img src="upload/architecture/instagram/2.jpg" alt=""></a></li>
							<li><a href="#"><img src="upload/architecture/instagram/3.jpg" alt=""></a></li>
							<li><a href="#"><img src="upload/architecture/instagram/4.jpg" alt=""></a></li>
							<li><a href="#"><img src="upload/architecture/instagram/5.jpg" alt=""></a></li>
							<li><a href="#"><img src="upload/architecture/instagram/6.jpg" alt=""></a></li>
							<li><a href="#"><img src="upload/architecture/instagram/7.jpg" alt=""></a></li>
							<li><a href="#"><img src="upload/architecture/instagram/8.png" alt=""></a></li>
						</ul>
					</div>
				</div>
							...
							<div class="col-lg-4">
								<div class="footer-widget-line">
									...
									<ul class="custom-list">
										<li><a href="#contact">Melbourne</a></li>
